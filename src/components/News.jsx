...
const News = ({ simplified }) => {
  ...
  if (error) return <div>coming soon ...</div>; // Handle error

  if (!cryptoNews?.value) return <Loader />; // Show loader while loading
  ...
  return (
    <Row gutter={[24, 24]}>
      ...
      {!cryptoNews.value && !error && (
        <Col xs={24} sm={24} lg={24} key="coming-soon">
